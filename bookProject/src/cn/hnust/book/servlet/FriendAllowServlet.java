...
public class FriendAllowServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			friendAllow = object.getString("friendAllow");
		...
		try {
			result = friendOperationService.friendAllow(studentId,friendId,friendAllow);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
