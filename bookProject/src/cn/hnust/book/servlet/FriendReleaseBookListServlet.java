...
public class FriendReleaseBookListServlet extends HttpServlet {
	 ...
	 */
	public FriendReleaseBookListServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			result = friendOperationService.findFriendReleaseBookList(studentId);
