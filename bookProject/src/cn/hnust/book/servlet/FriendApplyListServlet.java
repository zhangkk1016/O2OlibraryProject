...
public class FriendApplyListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			temp = friendOperationService.findApplyList(studentId);
			if(temp != null){
				result.put("result", "Success");
				result.put("information", temp);
			}
			else{
